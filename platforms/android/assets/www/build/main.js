...
var ProjectEndPage = (function () {
    function ProjectEndPage(navCtrl, navParams, alertCtrl, appService, events, toastCtrl, keyboard) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.alertCtrl = alertCtrl;
        this.appService = appService;
    ...
    ProjectEndPage.prototype.onClickCheck = function (value, index) {
        ...
        if (value == false) {
            ...
            switch (index) {
                ...
                case 3:
                    clearInterval(this.timer);
                    if (this.input_reason.nativeElement != null) {
                        this.timer = setInterval(function () {
                            _this.input_reason.nativeElement.focus();
                        }, 100);
                    }
                    break;
                default:
