...
var SubtaskPage = (function () {
    function SubtaskPage(navCtrl, navParams, appService, events, toastCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.appService = appService;
        this.events = events;
