...
var LoginPage = (function () {
    ...
    LoginPage.prototype.login = function (value) {
        this.appService.httpGet("http://tgw.qipai.com.cn:6121/uc/user/login", { "telPhone": value.mobile, "password": value.password }, this, function (view, res) {
            var data = res.json();
            if (data != null) {
