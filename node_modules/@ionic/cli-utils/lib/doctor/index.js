...
function treatAilments(env) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const ailments = yield Promise.all(exports.registry.ailments.map((ailment) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            count++;
            env.tasks.updateMsg(`Detecting issues: ${chalk.bold(`${count} / ${exports.registry.ailments.length}`)} complete`);
            return [ailment, detected];
        })));
        env.tasks.updateMsg(`Detecting issues: ${chalk.bold(`${exports.registry.ailments.length} / ${exports.registry.ailments.length}`)} complete`);
