    ...
    runCommand(env, pargv, opts = {}) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (command.metadata.backends && !command.metadata.backends.includes(config.backend)) {
                throw new errors_1.FatalException(`Sorry! The configured backend (${chalk.bold(config.backend)}) does not know about ${chalk.green('ionic ' + command.metadata.fullName)}.\n` +
            ...
            if (!env.project.directory && command.metadata.type === 'project') {
                throw new errors_1.FatalException(`Sorry! ${chalk.green('ionic ' + command.metadata.fullName)} can only be run in an Ionic project directory.`);
            }
